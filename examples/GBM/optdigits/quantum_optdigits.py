...
test_sampler = torch.utils.data.RandomSampler(opt_test,False,TEST_SAMPLES)
...
for t in range(5):
    ...
    for img_batch, labels_batch in train_loader:
        ...
        # Negative Phase
        vk, prob_hk = qa_sampler(num_reads=10000,num_spin_reversal_transforms=4)
